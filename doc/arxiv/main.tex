...
Many evolutionary problems can be formulated as a comparison of different independent evolutionary processes.
For instance, one could be interested in comparing the evolutionary trajectories of tumors in different patients to stratify patients or identify specific evolutionary patterns associated to particular therapies.
...
Then, we show the use of these geometric techniques in a series of biological examples, in the evolution of cancers and in infectious diseases. We study first the disruption of evolutionary trajectories by therapy in chronic lymphocytic leukemias, and the strong association between geometric information and the grade of relapse in low-grade gliomas. Then, we discuss the use of these geometric techniques in single-cell genomic data to systematically identify clonal replacement events in cancer. 
