...
A representative example of $\Psi_S$ is shown in figure~\ref{fig:dimred}.
...
\begin{figure}
    \centering
    \includegraphics[width=6in]{../figures/tree-dim-red-fig.pdf}
...
The approach we present here is based on sub-sampling of a larger structure and performing statistical analysis in lower dimensional projections.
...
We have applied the evolutionary moduli spaces framework to study the evolution of tumors under therapy, single cell genomic data, and influenza evolution. In particular, we have observed that the distributions of sample trees from genomic data can inform influenza vaccine efficacy in future seasons. The next step will be to find more expressive summarizations of distributions for framing prediction tasks. As sampling populations of viruses and cells become more extensive, we anticipate many problem statements amenable to the moduli framework.
...
\subsection{Supplementary: evolution of chronic lymphocytic leukemia under therapy}
