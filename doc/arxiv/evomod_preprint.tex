...
A series of four biologically motivated examples are presented, spanning cancer and infectious disease.
The first establishes that chemotherapy can disrupt the evolution of common leukemias. The second examines a link between geometric information and the histologic grade in relapsed gliomas, where longer relapse branches were specific to high grade glioma.
...
A negative correlation is observed between the influenza vaccine effectiveness during a season and the variance of the set trees constructed constructed using the preceding seasons' sequence data.
This provides an estimate of influenza vaccine effectiveness using genomic data. 
