...
Using a heavily restricted vocabulary of logical and arithmetic operators, we exhaustively searched~\cite{schmidt2009distilling} for a decision tree mapping the feature vectors to the binary label, under a fitness function of area under receiver operator characteristic.
